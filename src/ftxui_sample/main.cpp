...
// configuration step. It creates a namespace called `BphoOptics`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", BphoOptics::cmake::project_name, BphoOptics::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", BphoOptics::cmake::project_version);
      return EXIT_SUCCESS;
    }
